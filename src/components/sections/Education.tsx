          ...
          >
            ...
            <div className="relative border-l-2 border-gray-200 dark:border-gray-800 space-y-12 pb-4">
              ...
              <div className="relative pl-8">
                <div className="absolute w-5 h-5 bg-gray-300 dark:bg-gray-700 rounded-full -left-[11px] top-1 outline outline-4 outline-white dark:outline-gray-900 shadow-sm"></div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-2">
                  <h4 className="font-bold text-lg text-gray-900 dark:text-white leading-tight">Applied Professional Certification in AI Full Stack Development</h4>
                  <span className="text-xs font-bold px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-400 rounded-full border border-gray-200 dark:border-gray-700 w-fit whitespace-nowrap">April 2026</span>
                </div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-400 mb-4">AlmaBetter</p>
                <ul className="text-base text-gray-700 dark:text-gray-300 leading-relaxed list-disc list-outside ml-4 space-y-2 mb-6">
                  <li>Completed a hands-on AI full-stack program covering frontend, backend, and ML integration.</li>
                  <li>Built scalable applications incorporating machine learning workflows, APIs, and cloud-ready deployment patterns.</li>
                  <li>Validated capabilities through a verified Sertifier credential for practical production readiness.</li>
                </ul>
                <a
                  href="https://verified.sertifier.com/en/verify/05368566465739/"
                  target="_blank"
